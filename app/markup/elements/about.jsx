            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-6 mb-30">
                <div className="heading-bx">
                  ...
                  <h2 className="title">
                  Your Trusted Partner in Holistic Physiotherapy
                  </h2>
                  <p>
                  At Recure Physiotherapy, we are dedicated to providing comprehensive physiotherapy services tailored to meet your specific needs. Our team of experienced physiotherapists employs evidence-based techniques to ensure you receive the highest standard of care. Explore our wide range of services designed to enhance your health and well-being.
                  </p>
                </div>
                <div className="row">
                  ...
                  <div className="col-lg-6 col-sm-6 mb-30 mb-sm-20">
                    <div className="feature-container feature-bx1 feature4">
                      ...
                      <div className="icon-content">
                        <h4 className="ttr-title">Expert Team </h4>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-6 col-sm-6 mb-30 mb-sm-20">
