      ...
      <>
        ...
        <section className="section-area section-sp1">
          ...
          >
            <h6 className="title-ext text-secondary">Services</h6>
            <h2 className="title">
            At Recure, we offer a wide range of physiotherapy services designed to address various health concerns. Our specialised programs include:            </h2>
          </div> */}
          <div className="heading-bx text-center">
            <h2 className="title-ext text-secondary">Services</h2>
            <h2 className="title">
            Our specialised programs include: </h2>
          </div>
